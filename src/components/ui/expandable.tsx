...
const ExpandableCard = React.forwardRef<HTMLDivElement, ExpandableCardProps>(
  (
    ...
    const paddingClass = isFullWidth ? 'p-0' :'p-2 sm:p-3 md:p-4'
    return (
      <motion.div
        ref={ref}
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md shadow-black/5">
            <div 
              className={
                `rounded-md sm:rounded-lg md:rounded-3xl bg-white  shadow-xl ring-1 ring-black/5 ${paddingClass}`
              }
            >
...
ExpandableTriggerButton.displayName = "ExpandableTriggerButton"
